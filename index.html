...
<body>
    ...
    <div class="page-content" id="chatPage">
        ...
        <div class="ai-chat-container">
            <div class="chat-header">
                <span class="scramble">GASTER.NEURAL</span> | СТАТУС: <span class="glitch-word">АКТИВЕН</span>
            </div>
    ...
    <script>
        ...
        function initializeNetwork() {
            ...
            const layers = [8, 12, 16, 12, 6]; // Архитектура сети
        ...
        function simulateThinking() {
            ...
            // Имитация распространения активации
            for (let i = 0; i < 10; i++) {
                setTimeout(() => {
                    neurons.forEach(neuron => {
                        if (neuron.layer > 0) {
        ...
        function testNetwork() {
            ...
            // Тестируем на случайном примере из тренировочных данных
        ...
        function loadNetwork() {
            ...
            if (modelJSON && trainingDataJSON) {
                try {
                    ...
                    logToTrainingPanel('ОШИБКА ЗАГРУfunction loadNetwork() {
    const modelJSON = localStorage.getItem('gasterNeuralModel');
    const trainingDataJSON = localStorage.getItem('gasterTrainingData');
    ...
    if (modelJSON && trainingDataJSON) {
        try {
            ...
            networkStats.learningCycles = 1500; // Примерное значение
            networkStats.accuracy = 0.95; // Примерное значение
            updateNetworkStats();
